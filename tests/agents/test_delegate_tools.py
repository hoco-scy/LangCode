...
from LangCode.agents.delegate_tools import init_delegate_tools, create_delegate_tools, _make_delegate_tool
...
class TestDelegateToolBehavior:
    def test_agent_not_registered(self):
        init_delegate_tools({})
        tool_fn = _make_delegate_tool("code", "代码工程师")
